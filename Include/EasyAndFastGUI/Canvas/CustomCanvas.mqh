...
//+------------------------------------------------------------------+
uint CCustomCanvas::m_default_colors[9]=
  {
   XRGB(0,0,255),   // blue
   XRGB(255,0,0),   // red
   XRGB(0,128,0),   // green
...
//| Constructor                                                      |
//+------------------------------------------------------------------+
CCustomCanvas::CCustomCanvas(void) : m_objname(NULL),
...
//| Destructor                                                       |
//+------------------------------------------------------------------+
CCustomCanvas::~CCustomCanvas(void)
  {
  }
//+------------------------------------------------------------------+
//| Create dynamic resource                                          |
//+------------------------------------------------------------------+
bool CCustomCanvas::Create(const string name,const int width,const int height,ENUM_COLOR_FORMAT clrfmt)
  {
   Destroy();
//--- prepare data array
...
//+------------------------------------------------------------------+
bool CCustomCanvas::CreateBitmap(const string name,const datetime time,const double price,
...
//| Create object on chart with attached dynamic resource            |
//+------------------------------------------------------------------+
bool CCustomCanvas::CreateBitmap(const long chart_id,const int subwin,const string name,
                                 const datetime time,const double price,const int width,const int height,
...
//| Create object on chart with attached dynamic resource            |
//+------------------------------------------------------------------+
bool CCustomCanvas::CreateBitmapLabel(const string name,const int x,const int y,
                                      const int width,const int height,ENUM_COLOR_FORMAT clrfmt)
  {
...
//| Create object on chart with attached dynamic resource            |
//+------------------------------------------------------------------+
bool CCustomCanvas::CreateBitmapLabel(const long chart_id,const int subwin,const string name,
                                      const int x,const int y,const int width,const int height,
                                      ENUM_COLOR_FORMAT clrfmt)
  {
//--- create canvas
...
//+------------------------------------------------------------------+
void CCustomCanvas::Destroy(void)
  {
//--- delete object
   if(m_objname!=NULL)
     {
...
//| Resize                                                           |
//+------------------------------------------------------------------+
bool CCustomCanvas::Resize(const int width,const int height)
  {
//--- check
...
//| Clear/Fill color                                                 |
//+------------------------------------------------------------------+
void CCustomCanvas::Erase(const uint clr)
  {
...
//| Get pixel color                                                  |
//+------------------------------------------------------------------+
uint CCustomCanvas::PixelGet(const int x,const int y) const
  {
//--- check coordinates
...
//| Set pixel                                                        |
//+------------------------------------------------------------------+
void CCustomCanvas::PixelSet(const int x,const int y,const uint clr)
  {
//--- check coordinates
   if(x>=0 && x<m_width && y>=0 && y<m_height)
...
//+------------------------------------------------------------------+
void CCustomCanvas::Fill(int x,int y,const uint clr)
  {
//--- check
   if(x<0 || x>=m_width || y<0 || y>=m_height)
      return;
...
//| Draw vertical line                                               |
//+------------------------------------------------------------------+
void CCustomCanvas::LineVertical(int x,int y1,int y2,const uint clr)
  {
   int tmp;
//--- sort by Y
   if(y1>y2)
...
//+------------------------------------------------------------------+
void CCustomCanvas::LineHorizontal(int x1,int x2,int y,const uint clr)
  {
   int tmp;
//--- sort by X
   if(x1>x2)
...
//+------------------------------------------------------------------+
void CCustomCanvas::Line(int x1,int y1,int x2,int y2,const uint clr)
  {
//--- line is out of image boundaries
...
//| Draw polyline                                                    |
//+------------------------------------------------------------------+
void CCustomCanvas::Polyline(int &x[],int &y[],const uint clr)
  {
...
//| Draw polygon                                                     |
//+------------------------------------------------------------------+
void CCustomCanvas::Polygon(int &x[],int &y[],const uint clr)
  {
//--- check arrays
   int total=ArraySize(x);
   if(total>ArraySize(y))
...
//| Draw rectangle                                                   |
//+------------------------------------------------------------------+
void CCustomCanvas::Rectangle(int x1,int y1,int x2,int y2,const uint clr)
  {
   LineHorizontal(x1,x2,y1,clr);
...
//| Draw triangle                                                    |
//+------------------------------------------------------------------+
void CCustomCanvas::Triangle(int x1,int y1,int x2,int y2,int x3,int y3,const uint clr)
  {
...
//+------------------------------------------------------------------+
void CCustomCanvas::Circle(int x,int y,int r,const uint clr)
  {
   int f   =1-r;
   int dd_x=1;
   int dd_y=-2*r;
...
//+------------------------------------------------------------------+
void CCustomCanvas::Ellipse(int x1,int y1,int x2,int y2,const uint clr)
  {
   int x,y;
   int rx,ry;
   int dx,dy;
...
//| Draws ellipse arc                                                |
//+------------------------------------------------------------------+
void CCustomCanvas::Arc(int x1,int y1,int x2,int y2,int x3,int y3,int x4,int y4,const uint clr)
  {
   int    tmp;
   int    x,y;
   double fi3;
...
//| Draws ellipse arc                                                |
//+------------------------------------------------------------------+
void CCustomCanvas::Arc(int x,int y,int rx,int ry,double fi3,double fi4,const uint clr)
  {
   int x3,y3,x4,y4;
//--- check
   if(rx<10 || ry<10)
...
//+------------------------------------------------------------------+
double CCustomCanvas::AngleCalc(int x1,int y1,int x2,int y2)
  {
   double fi;
//--- check
   if(x1==x2)
...
//+------------------------------------------------------------------+
void CCustomCanvas::Arc(int x,int y,int rx,int ry,double fi3,double fi4,int &x3,int &y3,int &x4,int &y4,const uint clr)
  {
//--- check
   if(rx<10 || ry<10)
      return;
...
//| Draws ellipse pie                                                |
//+------------------------------------------------------------------+
void CCustomCanvas::Pie(int x1,int y1,int x2,int y2,int x3,int y3,int x4,int y4,const uint clr,const uint fill_clr)
  {
   int tmp;
   int x,y;
//---
...
//| Draws ellipse pie                                                |
//+------------------------------------------------------------------+
void CCustomCanvas::Pie(int x,int y,int rx,int ry,double fi3,double fi4,const uint clr,const uint fill_clr)
  {
   int x3=x;
   int y3=y;
   int x4=x;
...
//| Draw filled circle                                               |
//+------------------------------------------------------------------+
void CCustomCanvas::FillCircle(int x,int y,int r,const uint clr)
  {
   int f   =1-r;
   int dd_x=1;
   int dd_y=-2*r;
...
//| Draw filled ellipse                                              |
//+------------------------------------------------------------------+
void CCustomCanvas::FillEllipse(int x1,int y1,int x2,int y2,const uint clr)
  {
   int x,y;
   int rx,ry;
   int dx,dy;
...
//+------------------------------------------------------------------+
void CCustomCanvas::FillRectangle(int x1,int y1,int x2,int y2,const uint clr)
  {
   int tmp;
//--- sort vertexes
   if(x2<x1)
...
//+------------------------------------------------------------------+
void CCustomCanvas::FillTriangle(int x1,int y1,int x2,int y2,int x3,int y3,const uint clr)
  {
   int    xx1,xx2,tmp;
...
//| Draw filled poligon                                              |
//+------------------------------------------------------------------+
void CCustomCanvas::FillPolygon(int &x[],int &y[],const uint clr)
  {
   static CPoint p[];
   int total=ArraySize(x);
   if(total>ArraySize(y))
...
//+------------------------------------------------------------------+
void CCustomCanvas::PixelSetAA(const double x,const double y,const uint clr)
  {
   static double rr[4];
   static int    xx[4];
   static int    yy[4];
...
//| Set line style                                                   |
//+------------------------------------------------------------------+
void CCustomCanvas::LineStyleSet(const uint style)
  {
   switch(style)
     {
      case STYLE_SOLID:
...
//+------------------------------------------------------------------+
void CCustomCanvas::LineAA(const int x1,const int y1,const int x2,const int y2,const uint clr,const uint style)
  {
//--- line is out of image boundaries
   if((x1<0 && x2<0) || (y1<0 && y2<0))
      return;
...
//+------------------------------------------------------------------+
void CCustomCanvas::PolylineAA(int &x[],int &y[],const uint clr,const uint style)
  {
//--- set the line style
   LineStyleSet(style);
//--- check arrays
...
//+------------------------------------------------------------------+
void CCustomCanvas::PolygonAA(int &x[],int &y[],const uint clr,const uint style)
  {
//--- set the line style
   LineStyleSet(style);
//--- check arrays
...
//+------------------------------------------------------------------+
void CCustomCanvas::TriangleAA(const int x1,const int y1,const int x2,const int y2,const int x3,const int y3,const uint clr,const uint style)
  {
//--- set the line style
   LineStyleSet(style);
//--- draw
...
//+------------------------------------------------------------------+
void CCustomCanvas::CircleAA(const int x,const int y,const double r,const uint clr)
  {
   if(r<=0)
      return;
//--- preliminary calculations
...
//| Gets default color                                               |
//+------------------------------------------------------------------+
static uint CCustomCanvas::GetDefaultColor(const int i)
  {
   if(i<0)
      return(0);
...
//+------------------------------------------------------------------+
void CCustomCanvas::TransparentLevelSet(const uchar value)
  {
   uint clr;
   int total=ArraySize(m_pixels);
   for(int i=0;i<total;i++)
...
//| Set font                                                         |
//+------------------------------------------------------------------+
bool CCustomCanvas::FontSet(const string name,const int size,const uint flags,const uint angle)
  {
...
//| Set fontname                                                     |
//+------------------------------------------------------------------+
bool CCustomCanvas::FontNameSet(string name)
  {
...
//| Set fontsize                                                     |
//+------------------------------------------------------------------+
bool CCustomCanvas::FontSizeSet(int size)
  {
...
//| Set fontflags                                                    |
//+------------------------------------------------------------------+
bool CCustomCanvas::FontFlagsSet(uint flags)
  {
...
//| Set fontangle                                                    |
//+------------------------------------------------------------------+
bool CCustomCanvas::FontAngleSet(uint angle)
  {
...
//| Set font                                                         |
//+------------------------------------------------------------------+
bool CCustomCanvas::FontSet(void)
  {
...
//| Get font params                                                  |
//+------------------------------------------------------------------+
void CCustomCanvas::FontGet(string &name,int &size,uint &flags,uint &angle)
  {
   name =m_fontname;
   size =m_fontsize;
   flags=m_fontflags;
...
//| Out text                                                         |
//+------------------------------------------------------------------+
void CCustomCanvas::TextOut(int x,int y,string text,const uint clr,uint alignment)
  {
   if(FontSet())
...
//| Out text                                                         |
//+------------------------------------------------------------------+
void CCustomCanvas::TextOutFast(int x,int y,string text,const uint clr,uint alignment)
  {
   TextOut(text,x,y,alignment,m_pixels,m_width,m_height,clr,m_format);
  }
//+------------------------------------------------------------------+
//| Text width                                                       |
//+------------------------------------------------------------------+
int CCustomCanvas::TextWidth(const string text)
  {
   if(!FontSet())
      return(0);
//---
...
//| Text height                                                      |
//+------------------------------------------------------------------+
int CCustomCanvas::TextHeight(const string text)
  {
   if(!FontSet())
      return(0);
//---
...
//| Text rectangle                                                   |
//+------------------------------------------------------------------+
void CCustomCanvas::TextSize(const string text,int &width,int &height)
  {
   if(FontSet())
...
//| Load data from file                                              |
//+------------------------------------------------------------------+
bool CCustomCanvas::LoadFromFile(const string filename)
  {
   struct BitmapHeader
     {
      ushort            type;
...
//+------------------------------------------------------------------+
int CCustomCanvas::PointClassify(const CPoint &p0,const CPoint &p1,const CPoint &p2)
  {
...
//+------------------------------------------------------------------+
int CCustomCanvas::PolygonClassify(const CPoint &p[])
  {
...
//+------------------------------------------------------------------+
bool CCustomCanvas::IsPolygonConvex(CPoint &p[])
  {
   int total=ArraySize(p);
...
//+------------------------------------------------------------------+
void CCustomCanvas::PolygonNormalize(CPoint &p[])
  {
   int total=ArraySize(p);
//--- find top-left point
   int imin=0;
...
//+------------------------------------------------------------------+
void CCustomCanvas::PolygonIntersect(CPoint &p[],CPoint &add[])
  {
   int total=ArraySize(p);
...
//+------------------------------------------------------------------+
void CCustomCanvas::PolygonFill(CPoint &p[],const uint clr)
  {
   int    il,ir;
   double xl,xr;
   int    yy;
